...
public class BindingPlainImpl extends ASTWrapperPsiElement implements BindingPlain {

  public BindingPlainImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitBindingPlain(this);
  }
