...
public class NodeOperatorImpl extends ASTWrapperPsiElement implements NodeOperator {

  public NodeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitNodeOperator(this);
  }
