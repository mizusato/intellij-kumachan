...
public class StringPartContentImpl extends ASTWrapperPsiElement implements StringPartContent {

  public StringPartContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitStringPartContent(this);
  }
  ...
  public NodeText getNodeText() {
    return findChildByClass(NodeText.class);
  }
