...
public class PatternSingleImpl extends ASTWrapperPsiElement implements PatternSingle {

  public PatternSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitPatternSingle(this);
  }
