...
public class ArgMappingToImpl extends ASTWrapperPsiElement implements ArgMappingTo {

  public ArgMappingToImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitArgMappingTo(this);
  }
