...
public class PipeInfixImpl extends ASTWrapperPsiElement implements PipeInfix {

  public PipeInfixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitPipeInfix(this);
  }
  ...
  public PipeCall getPipeCall() {
    return findNotNullChildByClass(PipeCall.class);
  }
