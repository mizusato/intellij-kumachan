...
public class CondPatternImpl extends ASTWrapperPsiElement implements CondPattern {

  public CondPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitCondPattern(this);
  }
