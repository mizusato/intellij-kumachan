...
public class RecordDefImpl extends ASTWrapperPsiElement implements RecordDef {

  public RecordDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitRecordDef(this);
  }
  ...
  public List<Field> getFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Field.class);
  }
