...
public class RefTermImpl extends ASTWrapperPsiElement implements RefTerm {

  public RefTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitRefTerm(this);
  }
  ...
  public NodeNew getNodeNew() {
    return findChildByClass(NodeNew.class);
  }
