...
public class FieldDefaultImpl extends ASTWrapperPsiElement implements FieldDefault {

  public FieldDefaultImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitFieldDefault(this);
  }
