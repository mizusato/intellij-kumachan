...
public class CondImpl extends ASTWrapperPsiElement implements Cond {

  public CondImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CondPattern getCondPattern() {
    return findChildByClass(CondPattern.class);
  }
